...
const featureItems = [
  {
    ...
    description: "Describe your system, and Ghost AI maps it to nodes and edges on a live canvas.",
  },
  {
    icon: Network,
          ...
          <ul className="mt-16 space-y-8">
            {featureItems.map(({ description, icon: Icon, title }) => (
              <li key={title} className="flex gap-5">
                ...
                <div>
                  <h2 className="text-lg font-medium text-copy-secondary">{title}</h2>
